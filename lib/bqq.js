...
(function() {
  ...
  BQQ = (function() {
    BQQ.init = function(options) {
      this.appname = options.appname, this.key = options.key, this.secret = options.secret, this.ip = options.ip, this.start = options.start;
    ...
    BQQ.prototype.memberList = function() {
      var callback, query;
      callback = arguments.pop();
      query = this.baseParams();
      query.timestamp = arguments[0] || 0;
    ...
    BQQ.prototype.refresh = function(callback) {
      ...
      return BQQ.fetch('GET', 'oauth2/refresh', query, function(err, data) {
        ...
        data.data.old = _this.token;
        _this.token = data.data.access_token;
        _this.refreshToken = data.data.refresh_token;
